...
const openApiSpec: OpenApiSchema = {
  ...
  "put": {
    ...
    "description": "Admin/Superadmin only. Set isActive=false to archive or true to activate. At least one recognized field is required; unspecified fields are preserved. PM settings are a separate planning operation. Unknown fields are stripped.",
    "parameters": [
      {
        "name": "facilityId",
        "in": "path",
  ...
  "post": {
    ...
    "description": "Admin/Superadmin only, including when copying PM settings. Copies facility details and active state; blank or omitted name generates a copy name. Optional PM settings copy preserves enabled/default template and resets last/next PM dates. Source is retained. Unknown fields are stripped.",
    "parameters": [
      {
        "name": "facilityId",
        "in": "path",
